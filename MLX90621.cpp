...
void MLX90621::readEEPROM(uint8_t* eeprom_buffer) { // Read in blocks of 32 bytes to accomodate Wire library
	// TODO - Change this function to store its data to a passed buffer instead of locally storing

	if (size_t(eeprom_buffer) >= 256) {
...
void MLX90621::calculateTO() {
	//TODO - Change this function to print out its data rather than save it
...
void MLX90621::readIR() {
	//TODO - Swap the readIR method to use a passed in array
